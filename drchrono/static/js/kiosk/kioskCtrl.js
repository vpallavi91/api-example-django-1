(function() {
    ...
    app.controller('kioskCtrl', ['$scope', '$http', function($scope, $http) {
        ...
        // This is the caller function to retrieve appointment data from the backend
        ...
        // CALLER FUNCTION TO SET AN APPOINTMENT TO 'ARRIVED'
        ...
        // FUNCTION TO PATCH UPDATED PATIENT DATA TO DRCHRONO API
